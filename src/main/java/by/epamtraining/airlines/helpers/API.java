...
public class API {
    ...
    public static String getVKUrl(int pageNo, int recordCount) {
        return String.format(Locale.ROOT, VK_FEED_URL, VK_WALL_ID, recordCount, VK_VERSION, ACCESS_TOKEN, pageNo * recordCount);
    }
